...
Color shapeDecorationColor = Color.fromRGBO(246, 137, 137, 1);
Color shapeDecorationColorTwo = Color.fromRGBO(246, 137, 137, 1);
Color shapeDecorationTextColor = Color.fromRGBO(246, 137, 137, 1);
...
Color splashColorThree = Color.fromRGBO(246, 137, 137, 1);
Color iconTextColor = Colors.white;
Color buttonColor = Color.fromRGBO(246, 137, 137, 1);
Color textColor = Color.fromRGBO(246, 137, 137, 1);
...
class _GraduatesClassTeachersDetailsPage extends State<GraduatesClassTeachersDetailsPage> {
  ...
  Widget build(BuildContext context) {
    graduatesClassTeachersNotifier =
        Provider.of<GraduatesClassTeachersNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: graduatesClassTeachersNotifier
                            .currentGraduatesClassTeachers.image,
                        fit: BoxFit.cover,
                  ...
                  message: graduatesClassTeachersNotifier
                      .currentGraduatesClassTeachers.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(graduatesClassTeachersNotifier
                                .currentGraduatesClassTeachers.name
                                .toUpperCase(),
  ...
  initState() {
    ...
    GraduatesClassTeachersNotifier graduatesClassTeachersNotifier = Provider.of<
        GraduatesClassTeachersNotifier>(context, listen: false);

    _autoBio =
        graduatesClassTeachersNotifier.currentGraduatesClassTeachers.autoBio;
    _qualification =
        graduatesClassTeachersNotifier.currentGraduatesClassTeachers
            .qualification;
    _courseTeaching =
        graduatesClassTeachersNotifier.currentGraduatesClassTeachers
            .courseTeaching;
    _yearOfInception =
        graduatesClassTeachersNotifier.currentGraduatesClassTeachers
            .yearOfInception;
    _hobbies =
        graduatesClassTeachersNotifier.currentGraduatesClassTeachers.hobbies;
    _philosophy =
        graduatesClassTeachersNotifier.currentGraduatesClassTeachers.philosophy;
    _regionFrom = graduatesClassTeachersNotifier.currentGraduatesClassTeachers
        .regionOfOrigin;
    _email = graduatesClassTeachersNotifier.currentGraduatesClassTeachers.email;
    _facebook =
        graduatesClassTeachersNotifier.currentGraduatesClassTeachers.facebook;
    _linkedIn =
        graduatesClassTeachersNotifier.currentGraduatesClassTeachers.linkedIn;
    _instagram =
        graduatesClassTeachersNotifier.currentGraduatesClassTeachers.instagram;
    ...
    _twitter =
        graduatesClassTeachersNotifier.currentGraduatesClassTeachers.twitter;
                ...
                return Padding(
                  ...
                  child: InkWell(
                    ...
                    child: RaisedButton.icon(
                      ...
                      color: buttonColor,
                      icon: new Icon(
                          MdiIcons.linkedin, color: iconTextColor),
