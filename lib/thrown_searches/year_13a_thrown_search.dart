...
class MyYear13ClassASearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyYear13ClassASearch({@required this.all});
  ...
  Future navigateToYear13ClassADetailsPage(context) async {
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((year13ClassA) => year13ClassA.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((year13ClassA) => year13ClassA.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          year13ClassANotifier.currentYear13ClassA = search[position];
                          navigateToYear13ClassADetailsPage(context);
                        },
