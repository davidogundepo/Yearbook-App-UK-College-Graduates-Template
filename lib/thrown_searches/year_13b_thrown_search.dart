...
Color textHighlightColor = Color.fromRGBO(71, 69, 69, 1.0);

var queryTech;

class MyYear13ClassBSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyYear13ClassBSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((year13ClassB) => year13ClassB.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((year13ClassB) => year13ClassB.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          year13ClassBNotifier.currentYear13ClassB = search[position];
